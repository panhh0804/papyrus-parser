...
- 📦 **Batch Processing** — Parse entire directories in parallel with progress reporting
...
1. Download: https://github.com/panhh0804/papyrus-parser/archive/refs/heads/main.zip
2. Extract to your home directory
3. Rename folder to `papyrus`
4. Open terminal and `cd ~/papyrus`

Then choose the guide for your operating system:
...
Parse entire directories in parallel:
...
- 🌍 **跨平台** — 支持 macOS、Linux、Windows（旧版终端自动回退到 ASCII 输出）
- 🧠 **Agent 友好** — 为 AI 助手工作流设计
- 📦 **批量处理** — 并行解析整个目录，带实时进度报告
...
**方式 2：下载 ZIP（无需 Git）**
1. 下载：https://github.com/panhh0804/papyrus-parser/archive/refs/heads/main.zip
2. 解压到你的主目录
3. 将文件夹重命名为 `papyrus`
4. 打开终端，`cd ~/papyrus`
